 ...
 */
  ...
  */
		...
		value: function _loadOrderedNext(i, data) {
			...
			return i >= this._orderedDirectoriesBaseNames.length ? Promise.resolve() : this.loadByDirectory(path.join(this.directory, this._orderedDirectoriesBaseNames[i]), data).then(function () {
